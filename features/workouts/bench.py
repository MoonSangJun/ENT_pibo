...
# import random
# from features.motivation.dailyquest import check_daily_quest
            ...
            if results.pose_landmarks:
                ...
                if ready:
                    try:
                        ...
                        #이게 카운트 하기 전에.. 측정이 되어도 되는건가??

                        if left_angle < 90 and right_angle < 90:
                            if stage != "down":
                                stage = "down"
                                min_bench_angle = avg_angle
                            else:
                                min_bench_angle = min(min_bench_angle, avg_angle)
                            ...
                            feedback = (
                                "팔을 뎔 굽히세요." if min_bench_angle <= 70
                                else "팔을 더 굽히세요." if min_bench_angle >= 110
                                else "좋은 자세예요!"
                            )
